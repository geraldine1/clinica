...
class ForoController extends Controller
{
	...
	public function actionView($id)
	{
        ...
        public function actionPregunta(){
			...
			$model->attributes=$_POST['Foro'];
                        ...
                        $model->fecha_consulta = date("Y-m-d"); 
                        $model->respuesta = "No tiene aun";
                        $model->estado_consulta = "Pendiente";
			if($model->save())
				$this->redirect(array('index'));
            }
            $this->render('pregunta', array('model'=>$model));
        }
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Foro']))
		{
			$model->attributes=$_POST['Foro'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_foro));
		}
