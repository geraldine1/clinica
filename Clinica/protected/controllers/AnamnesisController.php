...
class AnamnesisController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Anamnesis']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_anamnesis));
		}
	...
	{
		$model=new Anamnesis('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Anamnesis']))
			$model->attributes=$_GET['Anamnesis'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='anamnesis-form')
		{
